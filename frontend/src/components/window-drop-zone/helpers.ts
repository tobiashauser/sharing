import { FileErrors, UploadFile, WindowDropzoneOptions } from "./types";
...
export const validateFiles = (
  ...
  files.forEach((file) => {
    ...
    if (file.file.type === "") {
      errors[file.name] = { error: "Folders are not supported", file };
    }
...
export const defaultWindowDropzoneOptions = {
  accept: ["*"],
  disabled: false,
} satisfies WindowDropzoneOptions;
